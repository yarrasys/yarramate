// Lives under src/host/ so `yarramate/host` can ship it without the
// editor bundle (ADR 0156); `yarramate/visual-app` re-exports it.
import {
...
import { SHIPPED_CATALOGUE } from '../tools/workspace.js'
          ...
          deliver?.frame({
            ...
            result: {
              ...
              matchedIds: matchedIdsOf(
                ...
                input.payload.nesting,
                input.payload.showResponsibility,
              ),
