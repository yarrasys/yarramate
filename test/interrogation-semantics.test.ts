...
> = {
  ...
  // Never fires here for the same reason and by the same rule: no vacancies
  // are passed, and "absent vacancies stay quiet" is the semantic to pin.
  'missing-part': ['      - condition: missing-part'],
